...
the former `w_en_bar`/`din_en` line (removed in V2.2.1), `s_en`, `sa_iso` across the columns; `wl_en` down the rows) as
...
V2.0.2 period sweeps do not validate the V2.2.1 phase schedule. `PSTC` is sampled
